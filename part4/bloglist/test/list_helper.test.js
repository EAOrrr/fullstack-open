...
describe('most likes', () => {
  ...
  test('when list has no blogs, return null', () => {
    result = listHelper.mostLikes(listWithNoBlog)
    assert.strictEqual(result, null)
  })

  test('when list has only one blog, return the author and likes of the blog', () => {
