...
export { specifiedRules, recommendedRules } from 'graphql/validation/specifiedRules';
...
export { MaxIntrospectionDepthRule } from 'graphql/validation/rules/MaxIntrospectionDepthRule';
